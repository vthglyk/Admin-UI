...
import {
    ...
    DISMISS_FEDERATION_DELETION_SUCCESS_ALERT, DEACTIVATEFEDERATION_DELETE_MODAL, DEACTIVATE_FEDERATION_DELETE_MODAL
} from "../actions/index";
...
class FederationList extends Component {
    ...
    render() {
        ...
        return(
            <Fragment>
                <AlertDismissable style="danger" message={federationDeletionError}
                                  dismissHandler={this.dismissFederationDeletionErrorAlert} />
                <AlertDismissable style="success" message={successfulFederationDeletion}
